...
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#include <Utils/Collection/IMap.mqh>
#include <Utils/Collection/IEqualityComparer.mqh>
#include <Utils/Collection/DefaultEqualityComparer.mqh>
#include <Utils/Collection/IComparable.mqh>
#include <Utils/Collection/CompareFunction.mqh>
#include "HashSet.mqh"
//+------------------------------------------------------------------+
